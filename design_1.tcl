...
\
  ...
  # Create instance: rst_ps8_0_149M, and set properties
  set rst_ps8_0_149M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_149M ]
  ...
  # Create instance: head_dim_4_top_module_0, and set properties
  set block_name head_dim_4_top_module
  set block_cell_name head_dim_4_top_module_0
  if { [catch {set head_dim_4_top_module_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $head_dim_4_top_module_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins head_dim_4_top_module_0/s_axi_o] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins head_dim_4_top_module_0/s_axi_qkv] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins head_dim_4_top_module_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins smartconnect_1/M01_AXI] [get_bd_intf_pins head_dim_4_top_module_0/s_axi_intc]
  connect_bd_intf_net -intf_net smartconnect_1_M02_AXI [get_bd_intf_pins smartconnect_1/M02_AXI] [get_bd_intf_pins axi_cdma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD] [get_bd_intf_pins smartconnect_1/S00_AXI]

  # Create port connections
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_pins axi_cdma_0/cdma_introut] [get_bd_pins head_dim_4_top_module_0/cdma_interrupt_in]
  connect_bd_net -net head_dim_4_top_module_0_irq [get_bd_pins head_dim_4_top_module_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net rst_ps8_0_149M_peripheral_aresetn [get_bd_pins rst_ps8_0_149M/peripheral_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins head_dim_4_top_module_0/s_axi_ctrl_aresetn] [get_bd_pins head_dim_4_top_module_0/s_axi_intc_aresetn] [get_bd_pins head_dim_4_top_module_0/s_axi_o_aresetn] [get_bd_pins head_dim_4_top_module_0/s_axi_qkv_aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins smartconnect_1/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins head_dim_4_top_module_0/clk] [get_bd_pins head_dim_4_top_module_0/s_axi_ctrl_aclk] [get_bd_pins head_dim_4_top_module_0/s_axi_intc_aclk] [get_bd_pins head_dim_4_top_module_0/s_axi_o_aclk] [get_bd_pins head_dim_4_top_module_0/s_axi_qkv_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins rst_ps8_0_149M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins smartconnect_1/aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_149M/ext_reset_in] [get_bd_pins axi_cdma_0/s_axi_lite_araddr]

  # Create address segments
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_cdma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs head_dim_4_top_module_0/s_axi_ctrl/reg0] -force
  assign_bd_address -offset 0x80002000 -range 0x00001000 -with_name SEG_head_dim_4_top_module_0_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs head_dim_4_top_module_0/s_axi_intc/reg0] -force
  assign_bd_address -offset 0x80040000 -range 0x00040000 -with_name SEG_head_dim_4_top_module_0_reg0_1 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs head_dim_4_top_module_0/s_axi_o/reg0] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -with_name SEG_head_dim_4_top_module_0_reg0_2 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs head_dim_4_top_module_0/s_axi_qkv/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW]
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI]
