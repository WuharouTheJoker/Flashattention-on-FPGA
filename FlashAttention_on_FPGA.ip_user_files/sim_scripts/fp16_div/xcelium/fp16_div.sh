...
#
# Script generated by Vivado on Thu Apr 16 13:19:43 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fp16_div.sh
...
#
# Usage        : fp16_div.sh
#                fp16_div.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp16_div.sh [-reset_run]
#                fp16_div.sh [-reset_log]
#                fp16_div.sh [-help]
#
...
#                script (type 'fp16_div.sh -help' for more information).
#
...
# script info
echo -e "fp16_div.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp16_div.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp16_div xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp16_div -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp16_div_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp16_div.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp16_div.sh [-help]\n\
Usage: fp16_div.sh [-step]\n\
Usage: fp16_div.sh [-lib_map_path]\n\
Usage: fp16_div.sh [-reset_run]\n\
Usage: fp16_div.sh [-reset_log]\n\
Usage: fp16_div.sh [-keep_index]\n\
Usage: fp16_div.sh [-noclean_files]\n\n\
