...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp16_div xil_defaultlib.glbl -o fp16_div_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp16_div_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fp16_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp16_div_simv.daidir vcs_lib c.obj)
