...
design_libs=(xilinx_vip xpm axi_lite_ipif_v3_0_4 axi_intc_v4_1_18 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_intc_0 xil_defaultlib.glbl -o axi_intc_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_intc_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_intc_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_intc_0_simv.daidir vcs_lib c.obj)
