...
design_libs=(xpm xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 floating_point_v7_1_16 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp16_add xil_defaultlib.glbl -o fp16_add_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp16_add_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fp16_add_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp16_add_simv.daidir vcs_lib c.obj)
