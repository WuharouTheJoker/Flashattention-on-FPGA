...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_bram_ctrl_v4_1_9 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_qkv xil_defaultlib.axi_bram_ctrl_qkv xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_bram_ctrl_qkv -key {Behavioral:sim_1:Functional:axi_bram_ctrl_qkv} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_88fd.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_bram_ctrl_qkv.wdb xsim.dir libdpi.so)
