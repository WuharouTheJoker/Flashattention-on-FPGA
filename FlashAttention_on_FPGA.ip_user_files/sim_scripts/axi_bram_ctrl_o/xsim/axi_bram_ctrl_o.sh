...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_bram_ctrl_v4_1_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_o xil_defaultlib.axi_bram_ctrl_o xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_bram_ctrl_o -key {Behavioral:sim_1:Functional:axi_bram_ctrl_o} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_bram_ctrl_o.wdb xsim.dir libdpi.so)
