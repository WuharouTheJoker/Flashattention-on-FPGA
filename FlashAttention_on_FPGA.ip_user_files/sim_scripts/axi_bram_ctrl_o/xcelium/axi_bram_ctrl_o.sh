...
#
# Script generated by Vivado on Wed May 06 16:43:52 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_bram_ctrl_o.sh
...
#
# Usage        : axi_bram_ctrl_o.sh
#                axi_bram_ctrl_o.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_bram_ctrl_o.sh [-reset_run]
#                axi_bram_ctrl_o.sh [-reset_log]
#                axi_bram_ctrl_o.sh [-help]
#
...
#                script (type 'axi_bram_ctrl_o.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_bram_ctrl_v4_1_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_bram_ctrl_v4_1_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_bram_ctrl_o.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_bram_ctrl_o.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_bram_ctrl_o xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_bram_ctrl_o -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_bram_ctrl_o_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_bram_ctrl_o.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_bram_ctrl_o.sh [-help]\n\
Usage: axi_bram_ctrl_o.sh [-step]\n\
Usage: axi_bram_ctrl_o.sh [-lib_map_path]\n\
Usage: axi_bram_ctrl_o.sh [-reset_run]\n\
Usage: axi_bram_ctrl_o.sh [-reset_log]\n\
Usage: axi_bram_ctrl_o.sh [-keep_index]\n\
Usage: axi_bram_ctrl_o.sh [-noclean_files]\n\n\
