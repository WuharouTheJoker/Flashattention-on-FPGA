...
#
# Script generated by Vivado on Wed May 06 16:54:45 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_flashattention2_unit_ctrl_1.sh
...
#
# Usage        : axi_flashattention2_unit_ctrl_1.sh
#                axi_flashattention2_unit_ctrl_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_flashattention2_unit_ctrl_1.sh [-reset_run]
#                axi_flashattention2_unit_ctrl_1.sh [-reset_log]
#                axi_flashattention2_unit_ctrl_1.sh [-help]
#
...
# script info
echo -e "axi_flashattention2_unit_ctrl_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_flashattention2_unit_ctrl_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_flashattention2_unit_ctrl_1 xil_defaultlib.axi_flashattention2_unit_ctrl_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_flashattention2_unit_ctrl_1 -key {Behavioral:sim_1:Functional:axi_flashattention2_unit_ctrl_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_flashattention2_unit_ctrl_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_flashattention2_unit_ctrl_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_flashattention2_unit_ctrl_1.sh [-help]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-step]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-lib_map_path]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-reset_run]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-reset_log]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-keep_index]\n\
Usage: axi_flashattention2_unit_ctrl_1.sh [-noclean_files]\n\n\
