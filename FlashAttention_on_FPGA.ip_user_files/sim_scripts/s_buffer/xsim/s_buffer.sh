...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L c_reg_fd_v12_0_7 -L c_mux_bit_v12_0_7 -L c_shift_ram_v12_0_15 -L xil_defaultlib -L secureip -L xpm --snapshot s_buffer xil_defaultlib.s_buffer -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim s_buffer -key {Behavioral:sim_1:Functional:s_buffer} -tclbatch cmd.tcl -log simulate.log
}
