...
design_libs=(xpm xbip_utils_v3_0_11 c_reg_fd_v12_0_7 c_mux_bit_v12_0_7 c_shift_ram_v12_0_15 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work c_mux_bit_v12_0_7 $vhdlan_opts \
  "../../../ipstatic/hdl/c_mux_bit_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work c_shift_ram_v12_0_15 $vhdlan_opts \
