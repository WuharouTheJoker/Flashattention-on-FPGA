...
design_libs=(xilinx_vip xpm lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 fifo_generator_v13_2_9 lib_fifo_v1_0_18 lib_cdc_v1_0_2 axi_datamover_v5_1_31 axi_sg_v4_1_17 axi_cdma_v4_1_29 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"F:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vhdlan -work axi_cdma_v4_1_29 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_cdma_0 xil_defaultlib.glbl -o axi_cdma_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_cdma_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_cdma_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_cdma_0_simv.daidir vcs_lib c.obj)
