...
module design_2
  ...
  wire head_dim_128_top_mod_0_irq;
  ...
  wire [20:0]smartconnect_1_M00_AXI_ARADDR;
  ...
  wire [20:0]smartconnect_1_M00_AXI_AWADDR;
  ...
  wire [17:0]smartconnect_2_M00_AXI_ARADDR;
  ...
  wire [17:0]smartconnect_2_M00_AXI_AWADDR;
  ...
  wire [48:0]smartconnect_2_M01_AXI_ARADDR;
  ...
  wire [3:0]smartconnect_2_M01_AXI_AWQOS;
  ...
  wire [127:0]smartconnect_2_M01_AXI_RDATA;
  ...
  wire [127:0]smartconnect_2_M01_AXI_WDATA;
  wire smartconnect_2_M01_AXI_WLAST;
  wire smartconnect_2_M01_AXI_WREADY;
  wire [15:0]smartconnect_2_M01_AXI_WSTRB;
  ...
  design_2_axi_cdma_0_0 axi_cdma_0
  ...
  design_2_axi_cdma_1_0 axi_cdma_1
       (.m_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  design_2_axi_gpio_0_1 axi_gpio_0
       (.gpio_io_i(head_dim_128_top_mod_0_irq),
  ...
  design_2_head_dim_128_top_mod_0_0 head_dim_128_top_mod_0
       (.cdma_interrupt_in(axi_cdma_0_cdma_introut),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .irq(head_dim_128_top_mod_0_irq),
        ...
        .s_axi_ctrl_arprot(smartconnect_0_M02_AXI_ARPROT),
        ...
        .s_axi_ctrl_awprot(smartconnect_0_M02_AXI_AWPROT),
        ...
        .s_axi_intc_araddr(smartconnect_0_M03_AXI_ARADDR),
        .s_axi_intc_aresetn(rst_ps8_0_149M_peripheral_aresetn),
        .s_axi_intc_arready(smartconnect_0_M03_AXI_ARREADY),
        .s_axi_intc_arvalid(smartconnect_0_M03_AXI_ARVALID),
        .s_axi_intc_awaddr(smartconnect_0_M03_AXI_AWADDR),
        .s_axi_intc_awready(smartconnect_0_M03_AXI_AWREADY),
        .s_axi_intc_awvalid(smartconnect_0_M03_AXI_AWVALID),
        .s_axi_intc_bready(smartconnect_0_M03_AXI_BREADY),
        .s_axi_intc_bresp(smartconnect_0_M03_AXI_BRESP),
        .s_axi_intc_bvalid(smartconnect_0_M03_AXI_BVALID),
        .s_axi_intc_rdata(smartconnect_0_M03_AXI_RDATA),
        .s_axi_intc_rready(smartconnect_0_M03_AXI_RREADY),
        .s_axi_intc_rresp(smartconnect_0_M03_AXI_RRESP),
        .s_axi_intc_rvalid(smartconnect_0_M03_AXI_RVALID),
        .s_axi_intc_wdata(smartconnect_0_M03_AXI_WDATA),
        .s_axi_intc_wready(smartconnect_0_M03_AXI_WREADY),
        .s_axi_intc_wstrb(smartconnect_0_M03_AXI_WSTRB),
        .s_axi_intc_wvalid(smartconnect_0_M03_AXI_WVALID),
        .s_axi_o_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s_axi_o_araddr(smartconnect_2_M00_AXI_ARADDR),
        .s_axi_o_arburst(smartconnect_2_M00_AXI_ARBURST),
        .s_axi_o_arcache(smartconnect_2_M00_AXI_ARCACHE),
        .s_axi_o_aresetn(rst_ps8_0_149M_peripheral_aresetn),
        .s_axi_o_arlen(smartconnect_2_M00_AXI_ARLEN),
        .s_axi_o_arlock(smartconnect_2_M00_AXI_ARLOCK),
        .s_axi_o_arprot(smartconnect_2_M00_AXI_ARPROT),
        .s_axi_o_arready(smartconnect_2_M00_AXI_ARREADY),
        .s_axi_o_arsize(smartconnect_2_M00_AXI_ARSIZE),
        .s_axi_o_arvalid(smartconnect_2_M00_AXI_ARVALID),
        .s_axi_o_awaddr(smartconnect_2_M00_AXI_AWADDR),
        .s_axi_o_awburst(smartconnect_2_M00_AXI_AWBURST),
        .s_axi_o_awcache(smartconnect_2_M00_AXI_AWCACHE),
        .s_axi_o_awlen(smartconnect_2_M00_AXI_AWLEN),
        .s_axi_o_awlock(smartconnect_2_M00_AXI_AWLOCK),
        .s_axi_o_awprot(smartconnect_2_M00_AXI_AWPROT),
        .s_axi_o_awready(smartconnect_2_M00_AXI_AWREADY),
        .s_axi_o_awsize(smartconnect_2_M00_AXI_AWSIZE),
        .s_axi_o_awvalid(smartconnect_2_M00_AXI_AWVALID),
        .s_axi_o_bready(smartconnect_2_M00_AXI_BREADY),
        .s_axi_o_bresp(smartconnect_2_M00_AXI_BRESP),
        .s_axi_o_bvalid(smartconnect_2_M00_AXI_BVALID),
        .s_axi_o_rdata(smartconnect_2_M00_AXI_RDATA),
        .s_axi_o_rlast(smartconnect_2_M00_AXI_RLAST),
        .s_axi_o_rready(smartconnect_2_M00_AXI_RREADY),
        .s_axi_o_rresp(smartconnect_2_M00_AXI_RRESP),
        .s_axi_o_rvalid(smartconnect_2_M00_AXI_RVALID),
        .s_axi_o_wdata(smartconnect_2_M00_AXI_WDATA),
        .s_axi_o_wlast(smartconnect_2_M00_AXI_WLAST),
        .s_axi_o_wready(smartconnect_2_M00_AXI_WREADY),
        .s_axi_o_wstrb(smartconnect_2_M00_AXI_WSTRB),
        .s_axi_o_wvalid(smartconnect_2_M00_AXI_WVALID),
        .s_axi_qkv_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s_axi_qkv_araddr(smartconnect_1_M00_AXI_ARADDR),
        .s_axi_qkv_arburst(smartconnect_1_M00_AXI_ARBURST),
        .s_axi_qkv_arcache(smartconnect_1_M00_AXI_ARCACHE),
        .s_axi_qkv_aresetn(rst_ps8_0_149M_peripheral_aresetn),
        .s_axi_qkv_arlen(smartconnect_1_M00_AXI_ARLEN),
        .s_axi_qkv_arlock(smartconnect_1_M00_AXI_ARLOCK),
        .s_axi_qkv_arprot(smartconnect_1_M00_AXI_ARPROT),
        .s_axi_qkv_arready(smartconnect_1_M00_AXI_ARREADY),
        .s_axi_qkv_arsize(smartconnect_1_M00_AXI_ARSIZE),
        .s_axi_qkv_arvalid(smartconnect_1_M00_AXI_ARVALID),
        .s_axi_qkv_awaddr(smartconnect_1_M00_AXI_AWADDR),
        .s_axi_qkv_awburst(smartconnect_1_M00_AXI_AWBURST),
        .s_axi_qkv_awcache(smartconnect_1_M00_AXI_AWCACHE),
        .s_axi_qkv_awlen(smartconnect_1_M00_AXI_AWLEN),
        .s_axi_qkv_awlock(smartconnect_1_M00_AXI_AWLOCK),
        .s_axi_qkv_awprot(smartconnect_1_M00_AXI_AWPROT),
        .s_axi_qkv_awready(smartconnect_1_M00_AXI_AWREADY),
        .s_axi_qkv_awsize(smartconnect_1_M00_AXI_AWSIZE),
        .s_axi_qkv_awvalid(smartconnect_1_M00_AXI_AWVALID),
        .s_axi_qkv_bready(smartconnect_1_M00_AXI_BREADY),
        .s_axi_qkv_bresp(smartconnect_1_M00_AXI_BRESP),
        .s_axi_qkv_bvalid(smartconnect_1_M00_AXI_BVALID),
        .s_axi_qkv_rdata(smartconnect_1_M00_AXI_RDATA),
        .s_axi_qkv_rlast(smartconnect_1_M00_AXI_RLAST),
        .s_axi_qkv_rready(smartconnect_1_M00_AXI_RREADY),
        .s_axi_qkv_rresp(smartconnect_1_M00_AXI_RRESP),
        .s_axi_qkv_rvalid(smartconnect_1_M00_AXI_RVALID),
        .s_axi_qkv_wdata(smartconnect_1_M00_AXI_WDATA),
        .s_axi_qkv_wlast(smartconnect_1_M00_AXI_WLAST),
        .s_axi_qkv_wready(smartconnect_1_M00_AXI_WREADY),
        .s_axi_qkv_wstrb(smartconnect_1_M00_AXI_WSTRB),
        .s_axi_qkv_wvalid(smartconnect_1_M00_AXI_WVALID));
  design_2_rst_ps8_0_149M_0 rst_ps8_0_149M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  design_2_smartconnect_0_1 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(1'b1));
  design_2_smartconnect_1_0 smartconnect_2
       (.M00_AXI_araddr(smartconnect_2_M00_AXI_ARADDR),
        ...
        .M01_AXI_arqos(smartconnect_2_M01_AXI_ARQOS),
        ...
        .M01_AXI_awqos(smartconnect_2_M01_AXI_AWQOS),
  ...
  design_2_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp2_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_LPD_ARADDR),
        ...
        .saxigp0_araddr(smartconnect_1_M01_AXI_ARADDR),
        .saxigp0_arburst(smartconnect_1_M01_AXI_ARBURST),
        .saxigp0_arcache(smartconnect_1_M01_AXI_ARCACHE),
        .saxigp0_arid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp0_arlen(smartconnect_1_M01_AXI_ARLEN),
        .saxigp0_arlock(smartconnect_1_M01_AXI_ARLOCK),
        .saxigp0_arprot(smartconnect_1_M01_AXI_ARPROT),
        .saxigp0_arqos(smartconnect_1_M01_AXI_ARQOS),
        .saxigp0_arready(smartconnect_1_M01_AXI_ARREADY),
        .saxigp0_arsize(smartconnect_1_M01_AXI_ARSIZE),
        .saxigp0_aruser(1'b0),
        .saxigp0_arvalid(smartconnect_1_M01_AXI_ARVALID),
        .saxigp0_awaddr(smartconnect_1_M01_AXI_AWADDR),
        .saxigp0_awburst(smartconnect_1_M01_AXI_AWBURST),
        .saxigp0_awcache(smartconnect_1_M01_AXI_AWCACHE),
        .saxigp0_awid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp0_awlen(smartconnect_1_M01_AXI_AWLEN),
        .saxigp0_awlock(smartconnect_1_M01_AXI_AWLOCK),
        .saxigp0_awprot(smartconnect_1_M01_AXI_AWPROT),
        .saxigp0_awqos(smartconnect_1_M01_AXI_AWQOS),
        .saxigp0_awready(smartconnect_1_M01_AXI_AWREADY),
        .saxigp0_awsize(smartconnect_1_M01_AXI_AWSIZE),
        .saxigp0_awuser(1'b0),
        .saxigp0_awvalid(smartconnect_1_M01_AXI_AWVALID),
        .saxigp0_bready(smartconnect_1_M01_AXI_BREADY),
        .saxigp0_bresp(smartconnect_1_M01_AXI_BRESP),
        .saxigp0_bvalid(smartconnect_1_M01_AXI_BVALID),
        .saxigp0_rdata(smartconnect_1_M01_AXI_RDATA),
        .saxigp0_rlast(smartconnect_1_M01_AXI_RLAST),
        .saxigp0_rready(smartconnect_1_M01_AXI_RREADY),
        .saxigp0_rresp(smartconnect_1_M01_AXI_RRESP),
        .saxigp0_rvalid(smartconnect_1_M01_AXI_RVALID),
        .saxigp0_wdata(smartconnect_1_M01_AXI_WDATA),
        .saxigp0_wlast(smartconnect_1_M01_AXI_WLAST),
        .saxigp0_wready(smartconnect_1_M01_AXI_WREADY),
        .saxigp0_wstrb(smartconnect_1_M01_AXI_WSTRB),
        .saxigp0_wvalid(smartconnect_1_M01_AXI_WVALID),
        .saxigp1_araddr(smartconnect_2_M01_AXI_ARADDR),
        .saxigp1_arburst(smartconnect_2_M01_AXI_ARBURST),
        .saxigp1_arcache(smartconnect_2_M01_AXI_ARCACHE),
        .saxigp1_arid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp1_arlen(smartconnect_2_M01_AXI_ARLEN),
        .saxigp1_arlock(smartconnect_2_M01_AXI_ARLOCK),
        .saxigp1_arprot(smartconnect_2_M01_AXI_ARPROT),
        .saxigp1_arqos(smartconnect_2_M01_AXI_ARQOS),
        .saxigp1_arready(smartconnect_2_M01_AXI_ARREADY),
        .saxigp1_arsize(smartconnect_2_M01_AXI_ARSIZE),
        .saxigp1_aruser(1'b0),
        .saxigp1_arvalid(smartconnect_2_M01_AXI_ARVALID),
        .saxigp1_awaddr(smartconnect_2_M01_AXI_AWADDR),
        .saxigp1_awburst(smartconnect_2_M01_AXI_AWBURST),
        .saxigp1_awcache(smartconnect_2_M01_AXI_AWCACHE),
        .saxigp1_awid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp1_awlen(smartconnect_2_M01_AXI_AWLEN),
        .saxigp1_awlock(smartconnect_2_M01_AXI_AWLOCK),
        .saxigp1_awprot(smartconnect_2_M01_AXI_AWPROT),
        .saxigp1_awqos(smartconnect_2_M01_AXI_AWQOS),
        .saxigp1_awready(smartconnect_2_M01_AXI_AWREADY),
        .saxigp1_awsize(smartconnect_2_M01_AXI_AWSIZE),
        .saxigp1_awuser(1'b0),
        .saxigp1_awvalid(smartconnect_2_M01_AXI_AWVALID),
        .saxigp1_bready(smartconnect_2_M01_AXI_BREADY),
        .saxigp1_bresp(smartconnect_2_M01_AXI_BRESP),
        .saxigp1_bvalid(smartconnect_2_M01_AXI_BVALID),
        .saxigp1_rdata(smartconnect_2_M01_AXI_RDATA),
        .saxigp1_rlast(smartconnect_2_M01_AXI_RLAST),
        .saxigp1_rready(smartconnect_2_M01_AXI_RREADY),
        .saxigp1_rresp(smartconnect_2_M01_AXI_RRESP),
        .saxigp1_rvalid(smartconnect_2_M01_AXI_RVALID),
        .saxigp1_wdata(smartconnect_2_M01_AXI_WDATA),
        .saxigp1_wlast(smartconnect_2_M01_AXI_WLAST),
        .saxigp1_wready(smartconnect_2_M01_AXI_WREADY),
        .saxigp1_wstrb(smartconnect_2_M01_AXI_WSTRB),
        .saxigp1_wvalid(smartconnect_2_M01_AXI_WVALID),
